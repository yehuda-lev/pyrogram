...
class AccentColor(AutoName):
    """Accent color enumeration used in :obj:`~pyrogram.types.ChatColor`.

    `More about accent colors. <https://core.telegram.org/bots/api#accent-colors>`_
    """
